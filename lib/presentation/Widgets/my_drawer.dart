              ...
              child: ListView(
                children: [
                  ...
                  listTitle(
                    ...
                    onTap: () {
                      Navigator.popAndPushNamed(
                          context, Routes.searchWidgetFilter);
                    },
                    title: AppStrings.addRegister,
                    image: Assets.imagesAddReqest,
                  ),
                  ListTile(
                    minLeadingWidth: AppSize.s30,
                    onTap: () {
                      Provider.of<LabModel>(context, listen: false)
                          .getLabsList();
                  ...
                  listTitle(
                    ...
                    title: AppStrings.labReportDaily,
                    image: Assets.imagesLabReport,
                  ),
                  listTitle(
                    context,
                    onTap: () {
                      Provider.of<LabReportModel>(context, listen: false)
                          .labReportList = [];
                      Navigator.pushNamed(
                          context, Routes.labMonthlyReportScreen);
                    },
                    title: AppStrings.labReportMonthly,
                    image: Assets.imagesLabReport,
                  ),
                  listTitle(
                    context,
                    ...
                    title: AppStrings.representatives,
                    image: Assets.imagesFastDelivery,
                  ),
                  listTitle(
                    context,
                    onTap: () {
                      Navigator.popAndPushNamed(
                          context, Routes.labsListScreens);
                    },
                    title: AppStrings.labs,
                    image: Assets.imagesLabsIcon,
                  ),
                  listTitle(
                    context,
                    onTap: () {
                      Navigator.popAndPushNamed(
                          context, Routes.analysisListScreens);
                    },
                    title: AppStrings.analysis,
                    image: Assets.imagesAnalysisIcon,
                  ),
                  ListTile(
                    minLeadingWidth: AppSize.s30,
                    onTap: () {
