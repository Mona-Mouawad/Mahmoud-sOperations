      ...
      child: Scaffold(
        ...
        body: Center(
          child: Container(
            ...
            padding:const EdgeInsets.symmetric(horizontal: AppPadding.p8,vertical: AppPadding.p28),
                ...
                child: Column(
                  ...
                  children: [
                    listTileItems(context, AppStrings.analysis, () {
                      Provider.of<AnalysisModel>(context,listen: false).getAnalysisName("");
                      Navigator.pushNamed(context, Routes.analysisListScreens);
                    }),
                    listTileItems(context, AppStrings.addNewAnalysis, () {showAddAnalysisOverLay(context,""); }),
                  ],
                ),
              ),
            ),
