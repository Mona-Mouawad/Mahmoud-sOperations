              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      item(
                          ...
                          image: Assets.imagesRegister,
                          context: context),
                      item(
                          text: AppStrings.labs,
                          function: () {
                            Provider.of<LabModel>(context, listen: false)
                                .getLabsList();
                  ...
                  Row(
                    ...
                    children: [
                      item(
                          text: AppStrings.representatives,
                          function: () {
                            Provider.of<RepresentativeModel>(context,
                                    listen: false)
                                .getRepresentatives();
                            Navigator.pushNamed(
                                context, Routes.representativesScreens);
                          },
                          image: Assets.imagesRepresentative,
                          context: context),
                      item(
                          ...
                          function: () {
                            Provider.of<AnalysisModel>(context, listen: false)
                                .getAnalysisList("");
                            Navigator.pushNamed(
                                context, Routes.analysisScreens);
                          },
                          image: Assets.imagesAnalysis,
                          context: context),
                    ],
                  ),
                ],
