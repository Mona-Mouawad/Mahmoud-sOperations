...
class RepresentativeMonthlyReportScreen extends StatefulWidget {
  ...
  @override
  State<RepresentativeMonthlyReportScreen> createState() =>
      _RepresentativeMonthlyReportScreenState();
}

class _RepresentativeMonthlyReportScreenState
    extends State<RepresentativeMonthlyReportScreen> {
              ...
              onTap: () {
                setState(() {
                  showDate(context, (value) {
                    ...
                    firstDayController.text = firstDay;
                    if (representativeData != null) {
                      report.getRepresentativesMonthlyReport(firstDay, lastDay,
