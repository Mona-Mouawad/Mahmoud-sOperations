...
class RepresentativeDayReportScreen extends StatefulWidget {
  ...
  @override
  State<RepresentativeDayReportScreen> createState() => _RepresentativeDayReportScreenState();
}

class _RepresentativeDayReportScreenState extends State<RepresentativeDayReportScreen> {
                          ...
                          child: TextFormField(
                            ...
                            onTap: () 
                              ...
                              await  showDate(context , (value) {
                                  ...
                                  _day.text = date[0];
                                  if(representativeData !=null ) {
                                    report.getRepresentativesDailyReport(
                                        _day.text, representativeData!.representativeId!).then((value) => setState((){}));
                                  }
                                }).then((value) => setState((){  }));
                            },
                          ),
                          ...
                          Card(
                            child: SizedBox(width:  MediaQuery.of(context).size.width /2 -AppSize.s30,
                              child: TextFormField(
                                ...
                                {
                                  setState(() {
                                   report.transValue =double.parse(val.isEmpty ? "0" : val);
                                    report.calculateTotal();
                                    if(representativeData !=null) {
                                      report.checkRepresentativesDayCost(
                                          _day.text ,representativeData!.representativeId!);
                        ...
                        prefixIcon: SizedBox(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: AppPadding.p5,
                                horizontal: AppPadding.p20),
                            child:  Icon(Icons.search ,size:AppSize.s20 ,
                              color: AppColors.grey,
                            ) ,
                            // SvgPicture.asset(ImageAssets.location_tick,
                            //     width: AppSize.s25),
